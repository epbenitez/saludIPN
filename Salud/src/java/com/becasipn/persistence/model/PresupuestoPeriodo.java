...
public class PresupuestoPeriodo implements Serializable, BaseBitacora, BaseEntity {

    @Id
    @GeneratedValue(generator = "EntPresPeriodoSeq")
    @SequenceGenerator(name = "EntPresPeriodoSeq", sequenceName = "ENT_PRESUPUESTO_PERIODO_ID_SEQ", allocationSize = 1)
    ...
    public String toString() {
        return "PresupuestoPeriodo{" + "id=" + id + ", periodo=" + (periodo == null ? "" : periodo.getClave()) + ", montoPresupuestado=" + montoPresupuestado + ", usuarioModifico=" + (usuarioModifico == null ? "" : usuarioModifico.getUsuario()) + ", fechaModificacion=" + fechaModificacion + '}';
    }
}
