 ...
 */
@Entity
@Table(name = "vw_presupuesto_unidadacademica")
@Cache(alwaysRefresh = true, type = org.eclipse.persistence.annotations.CacheType.NONE)
public class VWPresupuestoUnidadAcademica implements Serializable, BaseEntity {
