                ...
                <div class="main-box clearfix">
                    <div class="tabs-wrapper profile-tabs">
                        <ul class="nav nav-tabs">
                            <li><a href="#uno-tab" data-toggle="tab">Características básicas <i class="fa"></i></a></li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="uno-tab">                            
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Beca</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Temporalidad (meses)</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Fases</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label"> Validacion de inscripcion </label>
                                    <div class="col-sm-6">
                                        <s:select name="tipoBecaPeriodo.validaciondeinscripcion" list="validacionInscripcionList"
                                                  listKey="k1"
                                                  listValue="k2"
                                                  headerKey=""
                                                  cssClass="form-control"
                                        ...
                                        <s:hidden name="tipoBecaPeriodo.visible"/>
                                    </div>
                                </div>
                            </div>
                                    
                            <div class="tab-pane" id="dos-tab">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label"> ¿El alumno debe ser regular? </label>
                                    <div class="col-sm-6">
                            ...
                            <div class="tab-pane" id="tres-tab">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Promedio mínimo</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Promedio máximo</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Semestre mínimo</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Semestre máximo</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Número de materias aprobadas</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Monto máximo de ingresos per cápita</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Monto expresado en</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Vulnerabilidad SUBES</label>
                                    <div class="col-sm-6">
                                ...
                                <s:if test="tipoBecaPeriodo.tipoBeca.beca.id == 8">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label"> Gasto Transporte Mínimo </label>
                                        <div class="col-sm-6">
                                            <s:textfield cssClass="form-control" name="tipoBecaPeriodo.gastotransporteminimo" 
                                                         id="gastotransporteminimo" 
                                                         placeholder="Ingreso en salarios"
                                                         data-bv-message="Este dato no es válido"
                                                         pattern="^[\d.]+$"
                                                         data-bv-regexp-message="El campo no es válido"
                                    ...
                                    <s:hidden value="%{0}" name="tipoBecaPeriodo.gastotransporteminimo" />                           
                                </s:else>
                            </div>
                        </div>
                    </div>
...
//                alert(tabId);
            ...
            $('#uno-tab,#dos-tab,#tres-tab').on("mouseleave", function () {
                parent.window.jQuery.fancybox.update();
                //console.log(this);
            });
        });
    </script>
