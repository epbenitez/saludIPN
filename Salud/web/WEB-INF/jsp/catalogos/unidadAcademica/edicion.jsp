<%-- 
    Document   : Formulario de edición
    Created on : 4/11/2015, 05:11:08 PM
                ...
                <div class="main-box-body ">
                    <form id="unidadAcademica" action="/catalogos/guardaUnidadAcademica.action" method="post" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:select name="unidadAcademica.contactoPrincipal.id" list="contactosList" cssClass="form-control"
                                          listKey="id" listValue="nombreCompleto" headerKey=""
                                          headerValue="-- Seleccione un contacto principal --" 
                                          data-bv-notempty="true"
                                          data-bv-notempty-message="El contacto principal es requerido"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Contacto alterno</label>
                            <div class="col-sm-10">
                                <s:select name="unidadAcademica.contactoAlterno.id" list="contactosList" cssClass="form-control"
                                    listKey="id" listValue="nombreCompleto" headerKey=""
                                    headerValue="-- Seleccione un contacto alterno --" />
                            </div>
                        </div>
                        <div class="form-group">
