...
<head>
    <title>Correcciones Masivas: Estudio Socioeconómico</title>
    <link rel="stylesheet" type="text/css" href="/vendors/kartik-bootstrap-input/fileinput.min.css" />
</head> 
<content tag="tituloJSP">
	Correcciones Masivas: Estudio Socioeconómico
</content>
<body>
    <div class="col-sm-12">
        <div class="col-sm-12">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-12 text-center" style="padding-bottom: 5px" >
                                <a href="/resources/downloadable/Ejemplo_carga_integrantes_ingreso.xlsx" class="btn btn-primary btn-lg">
        ...
        <div class="col-xs-12">
            <div class="main-box clearfix">
                <div class="main-box-body">
                    <s:form cssClass="form-horizontal" id="cargaForm" namespace="/carga" action="cargaIntegrantesIngresoPerCapita.action" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input id="boton-carga" type="submit"  class="btn btn-primary" value="Cargar archivo"/>
                            </div>
                        </div>
    ...
    <script>
		...
		$("#archivo").fileinput({
			...
			allowedFileExtensions: ['xls', 'xlsx']
                ...
                //Desactiva boton de carga
                <security:authorize ifAnyGranted="ROLE_CONSULTA">
                    $("#boton-carga").attr("disabled", "disabled");
                </security:authorize>
