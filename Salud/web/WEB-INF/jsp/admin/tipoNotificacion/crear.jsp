<%-- 
    Document   : crearTipoNotificacion
...
<head>
    <title>Crear Tipo Notificación.</title>
...
<content tag="inlineScripts">
    <script>
                    ...
                    //Pone en blanco los Textfields del Color, Icono y de el Tipo. 
...
//        document.getElementById("icon").onfocus = function () {
//            document.getElementById("icon").disabled = "disabled";
//        };
