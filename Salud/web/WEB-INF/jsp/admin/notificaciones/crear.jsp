        ...
        <div class="col-sm-12">
            <s:if test="hasActionErrors()">
                <div class="alert alert-danger">
                    ...
                    <strong id="error">&iexcl;Error!</strong> <s:actionerror/>
                </div>
            </s:if>
        ...
        <div class="main-box clearfix" >
            ...
            <form id="notificaciones" action="/admin/guardaNotificaciones.action" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 input-group date" data-provide = "datepicker">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        <input type="text" class="form-control" id="fechaFinal" name="notificacion.fechaFinal" onkeydown="return false">
                    </div>
                </div>
...
<content tag="inlineScripts">
    <script>
                            ...
                            $(document).ready(function () {
                                ...
                                //quill.pasteHTML(<s:set var="texto" value= "notificacion.notificacion" />);

                                //Formato de la fecha para que coincida con la tabla de la DB.
