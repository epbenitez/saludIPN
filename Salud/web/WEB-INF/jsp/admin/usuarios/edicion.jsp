<%-- 
    Document   : edicion
    Created on : 17/11/2015, 04:24:06 PM
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield id="usuario"
                                             ...
                                             placeholder="Usuario"
                                             />
                                <span class="help-block" id="usuarioMessage" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textfield id="passwordRep"
                                             ...
                                             placeholder="********"
                                             />
                                <span class="help-block" id="passwordRepMessage" />
                            </div>
                        </div>
                        <div class="form-group">
...
<content tag="inlineScripts">
    <script>
        ...
        $(document).ready(function () {
            var soloLectura = <s:property value="lectura"/>
            if (soloLectura !== true)
            {
                $('#switch').bootstrapToggle('off');
            }
            $('#rol option[value=2]').hide();
            $("#passwordRep").val($("#password").val());
