<%-- 
    Document   : encuestaExitosa
    Created on : 20/11/2015, 01:44:53 PM
        ...
        <div class="col-xs-12">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-4 btn-group-vertical sm-12">
                    ...
                    <s:else>
                        <a class="btn btn btn-info" id="btn-msj "style="font-size: 15px"> &nbsp;&nbsp; Descargar archivo PDF</a>
                    </s:else>
        ...
        <s:if test="!eseTransporte">
                        ...
                        function mensajeSalud() {
                            ModalGenerator.notificacion({
                                "titulo": "Atención",
                                "cuerpo": "Aún no has contestado tu encuesta de salud. Necesitas contestarla para poder descargar el archivo PDF del estudio socioeconómico.",
                                "tipo": "WARNING",
                                "sePuedeCerrar": true
                            });
                        }
