...
<head>    
    ...
    <title>Solicitud Recurso Reconsideración</title>
</head> 

<content tag="tituloJSP">
    Solicitud Recurso Reconsideración
</content>
...
<body>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <s:if test="cuestionarioDiv">
                <div class="alert alert-info fade in">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <i class="fa fa-info-circle fa-fw fa-lg"></i>
                    Debes contestar <strong>TODAS</strong> las preguntas, después oprime el botón <strong>Finalizar</strong>, para terminar tu solicitud.
                </div>
            </s:if>
        </div>
        ...
        <div class="col-xs-12">
            <div class="main-box clearfix" >
                <div class="main-box-body ">
                    <h2>Descarga de archivo PDF</h2>
                    <hr/>
                    <form id="descargaPdf" class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-sm-2">
                                Solicitud Reconsideración 
                            </label>
                            <div class="col-sm-10 ">
                                <s:select id="solicitudPdf"
                                          cssClass="form-control"
                                          name="beca" 
                                          list="srList" 
                                          listKey="id" 
                                          listValue="solicitudBeca.programaBecaSolicitada.nombre" />
                            </div>
                        </div>
                        <div class="form-group pull-right">
                            <div class="col-sm-12">
                                <a href="#" target='_blank' onclick="addURL(this, 1)" id="ese" class="btn btn-primary" style="font-size: 15px"><span class="fa fa-download"></span> &nbsp;&nbsp;Descargar archivo PDF</a>
                            </div>
                        </div>
    ...
    <!--Datos de Solicitud Recurso Reconsideracion-->
    <div class="row" id="datosDiv" style="display: none">
        <div class="col-xs-12">
            <div class="main-box clearfix" >
                <div class="main-box-body ">
                    <h2>Datos de Solicitud Recurso Reconsideracion</h2>
                    <hr/>
                    <form action="/recursoReconsideracion/finalizarRecursoReconsideracion.action" method="post" id="passwordForm" class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-sm-2">
                                Solicitud Beca
                            </label>
                            <div class="col-sm-10">
                                <s:select id="solicitudBeca"
                                          cssClass="form-control"
                                          name="solicitudReconsideracion.solicitudBeca.id" 
                                          list="sbList" 
                                          listKey="id" 
                                          listValue="programaBecaSolicitada.nombre" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:select id="tipoInconf"
                                          cssClass="form-control"
                                          name="solicitudReconsideracion.tipoInconformidad.id" 
                                          list="ambiente.tipoInconformidadReconsideracionList" 
                                          listKey="id" 
                                          listValue="nombre" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <s:textarea cssClass="form-control"
                                            name="solicitudReconsideracion.solicitud"
                                            id="observaciones"
                                            cols="45"
                                            rows="5" 
                    ...
                    <!--                    <s:form action="/recursoReconsideracion/finalizarRecursoReconsideracion.action?cuestionarioId=7" id="formFinalizar" name="formFinalizar" method="post">
    ...
    <s:form action="finalizarRecursoReconsideracion.action?cuestionarioId=7"id="formFinalizar" name="formFinalizar" method="post">
        <s:hidden id="hResultdos2" name="hResultdos"/>
        <s:hidden id="cuestionarioId" name="cuestionarioId"/>
    </s:form> 
</div>
...
<content tag="inlineScripts">
    <script>
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        //Verificamos si debemos o no debemos mostrar el div del cuestionario
                                        if (<s:property value="cuestionarioDiv" />)
                                            document.getElementById("datosDiv").style.display = "block";

                                        //Verificamos si debemos o no debemos mostrar el div del pdf
                                        if (<s:property value="pdfDiv" />)
            ...
            <s:iterator value="respuestasUsuario">
                ...
                <s:else>
                                    ...
                                    function estatusFalse() {
                                        ModalGenerator.notificacion({
                                            "titulo": "Atención",
                                            "cuerpo": "No se puede finalizar tus estudio socioeconómico porque tus datos académicos no has sido actualizados.",
                                            "tipo": "INFO"
                                        });
                                    }
                                    ...
                                    function addURL(element, op) {
                                        ...
                                        $(element).attr('href', function () {
                                            var solicitudId = document.getElementById("solicitudPdf").value;
                                            return "/misdatos/descargar/pdfRecursoReconsideracion.action?solicitudReconsideracionId=" + solicitudId;
                                        });
                                    }
    </script>
</content>