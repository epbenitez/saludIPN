...
<head>    
    ...
    <title>Recurso Reconsideración</title>
</head> 
...
<body>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="col-sm-12">
                <div class="alert alert-info col-md-8 sm-12">
                    Deberás entregar tu Solicitud Ordinaria y la carta compromiso impresos en tu Unidad Académica.
                </div>
                <div class="col-sm-4 btn-group-vertical sm-12">
                    <s:if test="contestoSalud">
                        <!--style="color: #fc6a3c; background-color: #fff4c1"-->
                    ...
                    <a href="#" target='_blank' onclick="addURL(this, 2)" id="cartaCompromiso" class="btn btn-primary " style="font-size: 15px"><span class="fa fa-download"></span>&nbsp;&nbsp; Carta Compromiso</a>
                </div>
            </div>
        </div>
            ...
            <s:iterator value="respuestasUsuario">
                ...
                <s:else>
                        ...
                        function agregarImagenesTabs(idSeccion, nombreNavBar) {
                            switch (idSeccion) {
                                case 5:
                                    var txtNavBar = "<li class='active' id='1'><a href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><span class='visible-xs'>" + nombreNavBar + " </span><img id='salud1' src='/resources/img/ese/Paso1-active.png' class='hidden-xs'><i class=\"fa\"></i></a></li>";
                                    break;
                                case 6:
                                    var txtNavBar = "<li id='2'><a href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><span class='visible-xs'>" + nombreNavBar + " </span><img id='salud2' src='/resources/img/ese/Paso2.png' class='hidden-xs'><i class=\"fa\"></i></a></li>";
                                    break;
                                case 7:
                                    var txtNavBar = "<li id='3'><a href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><span class='visible-xs'>" + nombreNavBar + " </span><img id='salud3' src='/resources/img/ese/Paso3.png' class='hidden-xs'><i class=\"fa\"></i></a></li>";
                                    break;
                            }
                        ...
                        function addURL(element, op) {
                            ...
                            $(element).attr('href', function () {
                                if (op === 1) {
        <s:if test="!eseTransporte">
                                    mensajeSinTransporte();
        </s:if>
                                    return "/misdatos/descargar/pdfRecursoReconsideracion.action?cuestionarioId=7";
                                } else if (op === 2) {
                        ...
                        function mensajeSinTransporte() {
                            ModalGenerator.notificacion({
                                "titulo": "Atención",
                                "cuerpo": "Si deseas obtener la beca de transporte, contesta la Solicitud de Transporte ("
                                        + "<a href='/misdatos/requisitoBecaTransporte.action'> Solicitud de Transporte</a>) y entrégalo con los documentos que se solicitan en la convocatoria.",
                                "tipo": "WARNING",
                                "sePuedeCerrar": true
                            });
                        }
