    ...
    <script>
        ...
        <s:iterator var="preg" value="preguntas">
            ...
            <s:iterator value="respuestasUsuario">
                ...
                setValue('<s:property  value="pregunta.id"/>', '<s:property  value="respuestaAbierta" escape="false"/>');
                </s:if>
                <s:else>
                selectedValueSet('<s:property  value="pregunta.id"/>', '<s:property  value="respuesta.id" escape="false"/>');
                </s:else>
            </s:iterator>
