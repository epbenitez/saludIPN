        ...
        <div class="col-xs-12">
            ...
            <s:if test="periodoActivo">
                <div class="alert alert-info fade in">
                    ...
                    Debes contestar <strong>TODAS</strong> las preguntas, después oprime el botón <strong>Finalizar</strong>, para terminar tu censo de salud.
                </div>
            </s:if>
            <s:else>
                <div class="alert alert-danger">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="main-box clearfix">
                ...
                <s:form action="finalizarCuestionarioSalud.action?cuestionarioId=3 "id="formFinalizar" name="formFinalizar" method="post">
...
<content tag="inlineScripts">
    <script>
        ...
        function verificaTabs(stringEnvia)
        {
            validateTab = 0;
            wrong = [];
            aux = 0;
            ...
            for (k = 1; k < 4; k++)
            {
                if (document.getElementById("icon" + k).className === "fa fa-check")
                    validateTab++;
                else
                    wrong.push(k);
            }

            //Validar que los 3 tabs tengan palomita para confirmar que todas las preguntas fueron contestadas
            if (validateTab < 3) {
                if (wrong.length > 0)
                {
                    ModalGenerator.notificacion({
                        "titulo": "Datos incompletos",
                        "cuerpo": "Es necesario completar todos los campos. Por favor, verifica las preguntas del paso " + wrong.shift() + ".",
                        "tipo": "ALERT"
                    });
                }
            } else {
        ...
        function finalizarReg() {
            ...
            verificaTabs(stringEnvia);
        }

        function estatusFalse() {
            ModalGenerator.notificacion({
                "titulo": "Atención",
                "cuerpo": "No se puede finalizar tu solicitud de transporte porque tus datos académicos no han sido actualizados.",
                "tipo": "INFO"
            });
        }
        ...
        function agregarImagenesTabs(idSeccion, nombreNavBar) {
            switch (idSeccion) {
                case 5:
                    var txtNavBar = "<li class='active' id='1'><a id='ta1' href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><span class='visible-xs'>" + nombreNavBar + " </span><img id='salud1' src='/resources/img/ese/Paso1-active.png' class='hidden-xs'><i id='icon1' class=\"fa\"></i></a></li>";
                    break;
                case 6:
                    var txtNavBar = "<li id='2'><a id='ta2' href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><span class='visible-xs'>" + nombreNavBar + " </span><img id='salud2' src='/resources/img/ese/Paso2.png' class='hidden-xs'><i id='icon2' class=\"fa\"></i></a></li>";
                    break;
                case 7:
                    var txtNavBar = "<li id='3'><a id='ta3'  href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><span class='visible-xs'>" + nombreNavBar + " </span><img id='salud3' src='/resources/img/ese/Paso3.png' class='hidden-xs'><i id='icon3' class=\"fa\"></i></a></li>";
                    break;
            }
