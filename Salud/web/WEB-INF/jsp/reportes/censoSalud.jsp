...
<content tag="inlineScripts">
    <script>
                        ...
                        } else
                        {
                            ...
                            $.getJSON("/ajax/cuestionariosReporte",
                                    ...
                                    .done(function (response)
                                    {
                                        ...
                                        {
                                            document.getElementById("rowGrafica").style.display = "none";
                                            document.getElementById("main").style.display = "none";
                                            document.getElementById("downloadBTN").style.display = "none";

                                            ModalGenerator.notificacion({
                                                "titulo": "<i class='fa fa-exclamation-circle' style='padding-right: 15px'></i>Sin Datos",
                                                "cuerpo": "No se encuentran datos para el Censo de Salud en el periodo seleccionado.",
                                                "tipo": "ALERT",
                                                "sePuedeCerrar": true
                                            });
                                        } else {
                    ...
                    function generatePDF() {
                        ...
                        doc.save('SIBec - Censo de Salud.pdf'); /* Prompts user to save file on his/her machine */
                    }
