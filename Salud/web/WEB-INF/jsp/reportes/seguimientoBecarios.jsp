...
<head>
    <title>Estadísticas: Seguimiento Becarios</title>
...
<content tag="tituloJSP">
    Estadísticas: Seguimiento Becarios
</content>
...
<content tag="inlineScripts">
    <script>
                    ...
                    function crearTabs(idSeccion, tabActivo)
                    {
                        ...
                        {
                            case 8:
                                var txtNavBar = "<li onclick='tabs(" + idSeccion + ")' class='active' id='1'><a href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><img id='seguimiento1' src='/resources/img/seguimientoBecarios/1.jpg' class='hidden-xs'><i class=\"fa\"></i></a></li>";
                                break;
                            case 9:
                                var txtNavBar = "<li onclick='tabs(" + idSeccion + ")' id='2'><a href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><img id='seguimiento2' src='/resources/img/seguimientoBecarios/2-2.jpg' class='hidden-xs'><i class=\"fa\"></i></a></li>";
                                break;
                            case 10:
                                var txtNavBar = "<li onclick='tabs(" + idSeccion + ")' id='3'><a href=\"#" + idSeccion + "-tab\" data-toggle=\"tab\"><img id='seguimiento3' src='/resources/img/seguimientoBecarios/3-3.jpg' class='hidden-xs'><i class=\"fa\"></i></a></li>";
                                break;
                        }
                    ...
                    function drawDiv(preguntaid, seccion, pregunta)
                    {
                        ...
                        //$('#grafica-cuestionarios').append(divGrafica);
                    }
                    ...
                    function generatePDF() {
                        ...
                        for (var i = 0; i < imageTags.length; i++) {
                            ...
                            doc.text('SIBec | Reporte Seguimiento Becarios (' + periodoClave + ')', 350, 30);
                            doc.text('' + n + '', 460, 810);
                            yAxis = yAxis + 20; /* Update yAxis */
                            doc.addImage(imageTags[i], 'png', 40, yAxis, 530, 140, undefined, 'none');
                            yAxis = yAxis + 150; /* Update yAxis */
                        }
                        doc.save('SIBec - Reporte Seguimiento Becarios (' + periodoClave + ') .pdf'); /* Prompts user to save file on his/her machine */
                    }
